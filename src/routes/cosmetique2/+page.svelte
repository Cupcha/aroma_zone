		...
		<product-facet>
			...
			<div id="facet-main">
				<div id="nb-products" class="text-center text-xl">
					<span>Actif Concentré Ant-Capitons</span>
				</div>
			</div>
			...
			<product-list class="flex">
				...
				<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:h-auto object-center">
					...
					<div class="bg-white shadow-lg rounded-lg">
						<a href=" ">
							<img src={Cosmetique2} alt="Cosmetique2" class="rounded-t-lg center">
						</a>
						<div class="p-4">
						...
						<div class="p-4">
							<div class="flex mb-5">
								<a href=" ">
									...
									Actif Concentré Ant-Capitons
									</h1>
									<br>

									<h4 class="text-l text-gray-800  text-center ">
										Cet extrait concentré d'algues de la famille des Corallinacées a une action prouvée sur la cellulite : en boostant la synthèse des aquaporines, canaux qui jouent un rôle dans l'équilibre énergétique des cellules, il aide à réactiver la lipolyse dans les adipocytes, lutte contre le stockage des graisses, et favorise la restructuration et le raffermissement de la peau, diminuant ainsi visiblement l'aspect « capitons ». Un actif de haute technologie pour vos réaliser soins minceur !									</h4>
								</a>
								<p class="ml-auto text-l font-medium text-gray-800">5,25&euro;</p>
							</div>
							<br>
									<br>
									<br>
		...
		<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 md:h-auto">
			...
			<div class="bg-gray-200 shadow-lg rounded-lg ">
				<h5>
					Composition : 
					<br>
					<li> Cosmétique, extrait 100% naturel, sans conservateur ni additif</li>
