<script>
	...
	import Cosmetique3 from '$lib/images/Cosmetique3.png';
		...
		<product-facet>
			...
			<div id="facet-main">
				<div id="nb-products" class="text-center text-xl">
					<span>Bisabolol Végétal Bio</span>
				</div>
			</div>
			...
			<product-list class="flex">
				...
				<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:h-auto object-center">
					...
					<div class="bg-white shadow-lg rounded-lg">
						<a href=" ">
							<img src={Cosmetique3} alt="Cosmetique3" class="rounded-t-lg center">
						</a>
						<div class="p-4">
							...
							<div class="flex mb-5">
								<a href=" ">
									...
									<h4 class="text-l text-gray-800  text-center ">
										Composé actif existant dans plusieurs plantes dont la Camomille et le Candeia, l'alpha-bisabolol est connu comme actif apaisant puissant, très efficace à faible dose. C'est un excellent choix pour les soins des peaux sensibles et inconfortables. Il s'incorpore dans vos préparations de baumes, huiles et crèmes.									</h4>
								</a>
								<p class="ml-auto text-l font-medium text-gray-800">3,50&euro;</p>
							</div>
							<br>
									<br>
									<br>
		...
		<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 md:h-auto">
			...
			<div class="bg-gray-200 shadow-lg rounded-lg ">
				<h5>
					Composition : 
					<br>
					<li> Fraction de distillation de l'huile essentielle de Candeia (Vanillosmopsis Erythropappa), arbre originaire du Brésil, 
						100% d'origine végétale </li>
