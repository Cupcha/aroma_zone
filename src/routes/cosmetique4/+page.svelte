<script>
	...
	import Cosmetique5 from '$lib/images/Cosmetique5.png';
...
<svelte:head>
	<title>cosmetique5</title>
	<meta name="cosmetique5" content="Cosmetique5 shop Aroma-zone IE=edge width=device-width initial-scale=1.0">
			...
			<product-list class="flex">
				<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:h-auto object-center">
					<div class="bg-white shadow-lg rounded-lg flex justify-center items-center">
						<a href=" ">
							<img src={Cosmetique5} alt="Cosmetique5" class="rounded-t-lg center">
						</a>
						<div class="p-4"></div>
					</div>
							...
							<div class="flex mb-5">
								<a href=" ">
									...
									<h4 class="text-l text-gray-800   text-justify">
										D'origine 100% végétale et biologique, c'est un excellent agent adoucissant pour la peau et les cheveux. L'inuline est notamment très appréciée dans la formulation de soins capillaires en tant qu'actif conditionneur.
									</h4>								
								</a>
								<p class="ml-auto text-l font-medium text-gray-800">2.95&euro;</p>
							</div>
									<br>
									<br>
									<br>
		...
		<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 md:h-auto">
			...
			<div class="bg-gray-200 shadow-lg rounded-lg ">
				<h5>
					Composition : 
					<br>
					<li> 100% d'origine végétale (agave ou topinambour) et certifiée Biologique</li>
				</h5>
				<div class="p-4">
