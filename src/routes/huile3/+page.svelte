<script>
	...
	import Huile5 from '$lib/images/Huile5.png';
...
<svelte:head>
	<title>huile5</title>
	<meta name="huile5" content="Huile5 shop Aroma-zone IE=edge width=device-width initial-scale=1.0">
		...
		<product-facet>
			...
			<div id="facet-main">
				<div id="nb-products" class="text-center text-xl">
					<span>Huile essentielle d'Amande Amère</span>
				</div>
			</div>
			...
			<product-list class="flex">
				<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:h-auto object-center">
					<div class="bg-white shadow-lg rounded-lg flex justify-center items-center">
						<a href=" ">
							<img src={Huile5} alt="Huile5" class="rounded-t-lg center">
						</a>
						<div class="p-4"></div>
					</div>
							...
							<div class="flex mb-5">
								<a href=" ">
									...
									<h4 class="text-l text-gray-800   text-justify">
										Poudrée et envoûtante, l'huile essentielle d'amande amère séduit par son parfum suave et balsamique. Elle s'utilise à très faible dose en cuisine pour apporter une saveur amandée puissante.									</h4>
								</a>
		...
		<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 md:h-auto">
			...
			<div class="bg-gray-200 shadow-lg rounded-lg ">
				<h5>
					Composition : 
					<br>
					<li> Aldéhydes phénoliques : benzaldéhyde (98.91%)</li>
					<li>Acides phénoliques : acide benzoïque (0.76 %)</li>
				</h5>
				<div class="p-4">
