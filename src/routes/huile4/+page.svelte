<script>
	...
	import Huile4 from '$lib/images/Huile4.jpeg';
		...
		<product-facet>
			...
			<div id="facet-main">
				<div id="nb-products" class="text-center text-xl">
					<span>Huile essentielle d'Ajowan Bio</span>
				</div>
			</div>
			...
			<product-list class="flex">
				...
				<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:h-auto object-center">
					...
					<div class="bg-white shadow-lg rounded-lg">
						<a href=" ">
							<img src={Huile4} alt="Huile4" class="rounded-t-lg center">
						</a>
						<div class="p-4">
							...
							<div class="flex mb-5">
								<a href=" ">
									...
									<h4 class="text-l text-gray-800  text-center ">
										Egalement appelé Thym indien, l'Ajowan est connu dans la tradition ayurvédique comme stimulant et réchauffant. Purifiante et tonique, son huile essentielle est puissante et réputée en cas d'inconforts hivernaux.									</h4>
								</a>
								<p class="ml-auto text-l font-medium text-gray-800">3,10&euro;</p>
							</div>
							<br>
									<br>
									<br>
		...
		<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 md:h-auto">
			...
			<div class="bg-gray-200 shadow-lg rounded-lg ">
				<h5>
					Composition : 
					<br>
					<li> Monoterpènes : para-cymène (18.57%), gamma-terpinène (38.55%), béta-pinène (1.81%), alpha-pinène (0.34%),</li>
					
					<li>Phénols : thymol (37.05%), carvacrol (0.27%)</li>
