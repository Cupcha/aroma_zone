<script>
	...
	import Huile6 from '$lib/images/Huile6.png';
...
<svelte:head>
	<title>huile6</title>
	<meta name="huile6" content="Huile6 shop Aroma-zone IE=edge width=device-width initial-scale=1.0">
		...
		<product-facet>
			...
			<div id="facet-main">
				<div id="nb-products" class="text-center text-xl">
					<span>Huile essentielle d'Amyris</span>
				</div>
			</div>
			...
			<product-list class="flex">
				<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:h-auto object-center">
					<div class="bg-white shadow-lg rounded-lg flex justify-center items-center">
						<a href=" ">
							<img src={Huile6} alt="Huile6" class="rounded-t-lg center">
						</a>
						<div class="p-4"></div>
					</div>
							...
							<div class="flex mb-5">
								<a href=" ">
									...
									<h4 class="text-l text-gray-800   text-justify">
										Une huile à la senteur boisée, riche et tenace proche de celle du Santal blanc. Relaxante et positivante, cette huile procure un bien-être immédiat et favorise un climat de relaxation et de méditation.									</h4>
								</a>
		...
		<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 md:h-auto">
			...
			<div class="bg-gray-200 shadow-lg rounded-lg ">
				<h5>
					Composition : 
					<br>
					<li> Sesquiterpénols : valérianol (28.69%), 7-épi-alpha-eudesmol (13.00%), élémol (9.87%), 10-épi-gamma-eudesmol (9.09%), gamma-eudesmol (4.66%)</li>
				</h5>
				<div class="p-4">
