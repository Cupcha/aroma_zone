<script>
	...
	import Nutrition1 from '$lib/images/Nutrition1.png';
		...
		<product-facet>
			...
			<div id="facet-main">
				<div id="nb-products" class="text-center text-xl">
					<span>CBD 2,5% hydrosoluble</span>
				</div>
			</div>
			...
			<product-list class="flex">
				...
				<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:h-auto object-center">
					...
					<div class="bg-white shadow-lg rounded-lg">
						<a href=" ">
							<img src={Nutrition1} alt="Nutrition1" class="rounded-t-lg center">
						</a>
						<div class="p-4">
							...
							<div class="flex mb-5">
								<a href=" ">
									...
									<h4 class="text-l text-gray-800  text-center ">
										Du CBD haute qualité en version hydrosoluble, pour une utilisation très facile et un goût neutre, qui séduira le plus grand nombre ! Sa grande biodisponibilité et son absorption rapide procurent une efficacité optimale avec un dosage à 2,5% de Cannabidiol, on estime qu'il est équivalent à une huile CBD à 11% ! Ajoutez quelques gouttes de ce CBD 2,5% hydrosoluble à une boisson avant de dormir, après le sport, ou dans votre gourde d'eau pour l'emporter partout pour une action bien-être tout au long de la journée !									</h4>
								</a>
								<p class="ml-auto text-l font-medium text-gray-800">18,90&euro;</p>
							</div>
							<br>
									<br>
									<br>
