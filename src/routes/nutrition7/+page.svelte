		...
		<product-facet>
			...
			<div id="facet-main">
				<div id="nb-products" class="text-center text-xl">
					<span>Complément alimentaire vitamine D3 vegan - 10mL</span>
				</div>
			</div>
						...
						<div class="p-4">
							<div class="flex mb-5">
								<a href=" ">
									...
									Complément alimentaire vitamine D3 vegan - 10mL
									</h1>
									<br>
		...
		<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 md:h-auto">
			...
			<div class="bg-gray-200 shadow-lg rounded-lg ">
				<h5>
					Composition : 
					<br>
					<li> Huile MCT (de Coco, support), D-alphatocophérol (antioxydant d'origine naturelle), Cholécalciférol (vitamine D3, dérivée d'algues)</li>
