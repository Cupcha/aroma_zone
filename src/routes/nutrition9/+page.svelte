<script>
	...
	import Nutrition9 from '$lib/images/Nutrition9.png';
		...
		<product-facet>
			...
			<div id="facet-main">
				<div id="nb-products" class="text-center text-xl">
					<span>Poudre de thé vert matcha du Japon bio</span>
				</div>
			</div>
		...
		<div class="max-w-2xl mx-auto px-4 py-8 lg:max-w-7xl grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 md:h-auto">
			...
			<div class="bg-gray-200 shadow-lg rounded-lg ">
				<h5>
					Composition : 
					<br>
					<li>100 % poudre de feuilles de thé vert Matcha (Camellia sinensis) biologique</li>
